      ...
      <div className="relative flex items-start justify-between">
        ...
        <div>
          ...
          <div className="text-[10px] tracking-[.26em] uppercase text-sand-300/90">
            {t("dashboard.hiddenSavings")}
          </div>


          <div className="mt-3.5 flex items-baseline gap-1.5">
            <span className="font-display text-2xl text-sand-200/80">
              ₹
            </span>
          ...
          {!decoy && weekDelta > 0 && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="
                deva mt-3 inline-flex items-center gap-1.5
                rounded-full bg-sand-50/15
                px-3 py-1 text-[12.5px] text-sand-50
              "
            >
              ...
              {t("dashboard.weekSaving", {
                amount: weekDelta.toLocaleString("en-IN"),
              })}
        ...
        >
          ...
          <motion.div
            ...
            transition={{
              repeat: decoy ? 0 : Infinity,
              repeatDelay: 4.5,
              duration: 1.6,
            }}
            className="
              w-4 h-4 rounded-full
              border-2 border-sand-100
